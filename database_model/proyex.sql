...
CREATE TABLE IF NOT EXISTS `project_tag` (
  ...
  INDEX `fk_project_tag_tags1_idx` (`tag_id` ASC),
...
CREATE TABLE IF NOT EXISTS `project_updates` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_project_updates_projects1_idx` (`project_id` ASC),
  INDEX `fk_project_updates_users1_idx` (`updater_user_id` ASC),
  FULLTEXT INDEX `project_updates_description_FULLTEXT` (`description`),
...
CREATE TABLE IF NOT EXISTS `projects` (
  ...
  INDEX `fk_projects_users1_idx` (`reporter_user_id` ASC),
  INDEX `fk_projects_users2_idx` (`assigned_user_id` ASC),
  FULLTEXT INDEX `projects_title_FULLTEXT` (`title`),
  FULLTEXT INDEX `projects_description_FULLTEXT` (`description`),
