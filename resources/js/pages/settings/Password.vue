            ...
            <div class="rounded-2xl border border-neutral-200 bg-white p-6 shadow-sm dark:border-neutral-800 dark:bg-neutral-900">
                <div class="max-w-xl space-y-6">
                    ...
                    >
                        ...
                        <div class="grid gap-2">
                            <Label for="password" class="text-sm font-semibold text-neutral-700 dark:text-neutral-300">New password</Label>
                            <Input
                                id="password"
                                ref="passwordInput"
                                name="password"
                        ...
                        <div class="grid gap-2">
                            <Label for="password_confirmation" class="text-sm font-semibold text-neutral-700 dark:text-neutral-300"
